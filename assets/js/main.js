...
function downloadCV() {
    ...
    link.href = './Aya-Nasr-cv.pdf';
    link.download = 'Aya-Nasr resume.pdf';
    link.click();  
}


document.addEventListener("DOMContentLoaded", function() {
    document.getElementById("redirecte").addEventListener("click", function() {
        window.location.href = "https://drive.google.com/file/d/11LeOzdoiESPXyluqfaSUZUvsF1zoBXlx/view?usp=sharing";
    });
});
// https://drive.google.com/file/d/11LeOzdoiESPXyluqfaSUZUvsF1zoBXlx/view?usp=sharing